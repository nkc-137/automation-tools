"""
Created on Sat July 13 15:18:55 2015

@author: Kapil Chandra
"""
import wx
import wx.xrc
#below are the variables that will be use to send
ir_us=''
ir_pa=''
to_st=''
fr_st=''
...
if (sbi_nb):#checking if sbi netbanking is selected, and going through it if it is true
    ...
    sb = driver.find_element_by_id("jpBook:bankINBList")
    sb.send_keys("State Bank of India")
